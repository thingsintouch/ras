...
PERIOD_SHUTDOWN_BUTTON = 0.9 # in seconds
...
LOOPS_TO_WAIT_SHUTDOWN_BUTTON = 5 # in loops
...
PIN_RELAY = 29
PIN_SHUTDOWN_BUTTON = 31 # BCM notation for GPIO 6
PIN_POWER_FOR_SHUTDOWN_BUTTON = 35   # BCM notation for GPIO 19

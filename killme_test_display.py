...
try:
    device_display = sh1106( serial_interface = i2c(port=1, address='0x3C') )
except Exception as e:
    print(f"exception while getting device {e}")
    #parser.error(e)
...
# origin = [0,0]
# size = 13
# text = "Browse to\n192.168.178.142:3000\nto introduce new\nOdoo Parameters"
origin = [0,0]
size = 16
text = ">>> CHECK IN .....\n-EmployeePlaceholder-\n-EmployeePlaceholder-\n-EmployeePlaceholder-\n-----------------"
#text = "line1\nline2\nline3\nline4\nline5\nline6\nline7"
font = ImageFont.truetype(fontRoboto, size)
with canvas(device_display) as draw:
